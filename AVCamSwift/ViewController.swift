...
class ViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
    ...
    @IBOutlet var cameraStill: UIImageView!
...
//                    self.snapButton.enabled = true
    ...
    @IBAction func close(sender: AnyObject) {
        ...
        if self.deleteVideo && status == .Still{
            ...
            do {
                try NSFileManager.defaultManager().removeItemAtURL(videoFilePath!)
            } catch _ {
            }
        } else if !self.deleteVideo{
    ...
    noteCenter.addObserverForName(AVPlayerItemDidPlayToEndTimeNotification, object: nil, queue: nil, usingBlock: {(note: NSNotification) -> Void in
    ...
    @IBAction func toggleMovieRecord(sender: AnyObject) {
        ...
        dispatch_async(self.sessionQueue, {
            if !self.movieFileOutput!.recording{
                ...
                self.videoFilePath = outputFilePath
